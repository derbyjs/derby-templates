...
ViewParent.prototype.dependencies = function(context, forInnerPath) {
  var parentContext = context.forViewParent();
  return this.template.dependencies(parentContext, forInnerPath);
};
...
TemplateClosure.prototype.dependencies = function(ignoredContext, forInnerPath) {
  return this.template.dependencies(this.context, forInnerPath);
};
