...
ParentWrapper.prototype.get = function(context, unescaped) {
  return (this.expression || this.template).get(context.parent, unescaped);
};
...
ParentWrapper.prototype.attachTo = function(parent, node, context) {
  return this.template.attachTo(parent, node, context.parent);
};
ParentWrapper.prototype.resolve = function(context) {
  return this.expression && this.expression.resolve(context.parent);
};
ParentWrapper.prototype.dependencies = function(context) {
  return (this.expression || this.template).dependencies(context.parent);
};
...
ElementOn.prototype.emit = function(context, element) {
  ...
  element.addEventListener(this.name, function elementOnListener(e) {
    return expression.apply(context, [e, element])
  }, false);
};
