...
View.prototype._initComponent = function(context, noHooks) {
  return (this._isComponent(context)) ?
    this.componentFactory.init(context, noHooks) : context;
};
...
View.prototype.get = function(context, unescaped) {
  var noHooks = true;
  var viewContext = this._initComponent(context, noHooks);
  var template = this.template || this._parse();
