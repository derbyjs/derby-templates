...
function ContextMeta(options) {
  this.addBinding = options.addBinding || noop;
  this.removeBinding = options.removeBinding || noop;
  this.addItemContext = options.addItemContext || noop;
  this.removeItemContext = options.removeItemContext || noop;
