...
exports.TreeFnExpression = TreeFnExpression;
exports.OperatorExpression = OperatorExpression;
exports.NewExpression = NewExpression;
exports.TreeNewExpression = TreeNewExpression;
...
FnExpression.prototype.apply = function(context, extraInputs) {
  ...
  var fn;
  while (controller) {
    var fn = this._lookup(controller);
    if (fn) break;
    controller = controller.parent;
  }
  var getFn = (fn && fn.get) || fn;
  return this._applyFn(getFn, context, extraInputs, controller);
};
FnExpression.prototype._lookup = function(controller) {
...
FnExpression.prototype._applyFn = function(fn, context, extraInputs, thisArg) {
  if (!fn) throw new Error('Function not found for: ' + this.name);
...
function TreeFnExpression(name, segments, args, afterSegments) {
  this.name = name;
  this.segments = segments;
  this.args = args;
  this.afterSegments = afterSegments;
...
TreeFnExpression.prototype = new FnExpression();
TreeFnExpression.prototype._lookup = function(controller) {
  return lookup(this.segments, controller);
};
...
function NewExpression(name, args, afterSegments) {
  this.name = name;
  this.args = args;
  this.afterSegments = afterSegments;
  this.meta = null;
...
function TreeNewExpression(name, segments, args, afterSegments) {
  this.name = name;
  this.segments = segments;
  this.args = args;
  this.afterSegments = afterSegments;
...
TreeNewExpression.prototype = new NewExpression();
TreeNewExpression.prototype._lookup = TreeFnExpression.prototype._lookup;
