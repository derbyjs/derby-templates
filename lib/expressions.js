...
function renderValue(value, context) {
  return (typeof value !== 'object') ? value :
    (value instanceof templates.Template) ? value.get(context) :
    (Array.isArray(value)) ? renderArray(value, context) :
    renderObjectProperties(value, context);
}
...
function renderObjectProperties(object, context) {
  ...
  for (var key in object) {
    ...
    out[key] = (value instanceof templates.Template) ? value.get(context) : value;
  }
  return out;
}
