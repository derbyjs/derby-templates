...
ViewParentExpression.prototype.dependencies = function(context, forInnerPath) {
  var parentContext = context.forViewParent();
  return this.expression.dependencies(parentContext, forInnerPath);
};
...
function outerDependency(expression, context, forInnerPath) {
  ...
  if (value instanceof templates.Template) {
    var valueDependencies = value.dependencies(context);
    if (valueDependencies) {
      valueDependencies.push(segments);
